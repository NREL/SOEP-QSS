...
CFLAGS := -pipe -std=c2x -pedantic -march=native -Wall -Wextra -Wno-unknown-pragmas -Wimplicit-fallthrough -pthread -DNDEBUG -O3 -ffp-model=precise -fno-stack-protector
