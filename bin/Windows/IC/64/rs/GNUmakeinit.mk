...
# Variables
CXXFLAGS := /nologo /Qstd=c++11 /Qcxx-features /Wall /Qdiag-disable:809,1786,2259,3280,10382,11074,11075 /QxHOST /DNOMINMAX /DWIN32_LEAN_AND_MEAN /DWIN32 /DFMILIB_STATIC_LIB_ONLY /DNDEBUG /Qansi-alias /O3 /fp:fast=2 /Qprec-div- /Qip /Qinline-factor:225 /MD
CFLAGS := /nologo /Qstd=c99 /Wall /Qdiag-disable:177,869,1478,1684,1786,2259,2312,2557,3280,10382,11074,11075 /QxHOST /DWIN32_LEAN_AND_MEAN /DWIN32 /DFMILIB_STATIC_LIB_ONLY /DNDEBUG /Qansi-alias /O3 /fp:fast=2 /Qprec-div- /Qip /MD
# Disabled Warnings:
