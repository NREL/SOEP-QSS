...
# Variables
CXXFLAGS := -pipe -std=c++20 -pedantic -fopenmp -march=native -Wall -Wextra -Wno-unknown-pragmas -Wno-attributes -Wimplicit-fallthrough=5 -DWIN32 -DNDEBUG -O3 -ffloat-store -fno-stack-protector -finline-limit=2000
...
CFLAGS := -pipe -std=c2x -pedantic -march=native -Wall -Wextra -Wno-unknown-pragmas -Wno-attributes -Wimplicit-fallthrough=5 -DWIN32 -DNDEBUG -O3 -ffloat-store -fno-stack-protector -finline-limit=2000
