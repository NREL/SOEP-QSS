...
# Variables
CXXFLAGS := -pipe -std=c++11 -pedantic -Wall -Wextra -Wno-unknown-pragmas -Wno-attributes -m64 -march=native -ffloat-store -fsignaling-nans -fno-omit-frame-pointer -DWIN32 -DQSS_FMU -O0 -ggdb
