#ifndef QSS_dfn_mdl_Function_nonlinear_ND_hh_INCLUDED
#define QSS_dfn_mdl_Function_nonlinear_ND_hh_INCLUDED
...
public: // Properties
	...
	{
		return dtn_inv_2_ * ( ( q_p_ = q( t + dtn_ ) ) - ( q_m_ = q( t - dtn_ ) ) );
	}
