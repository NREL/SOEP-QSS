...
set CC=cl
set C_FLAGS=/nologo /std:c17 /EHsc /arch:AVX2 /W3 /wd4013 /wd4068 /wd4244 /wd4267 /wd4273 /wd5105 /DNOMINMAX /DWIN32_LEAN_AND_MEAN /DNDEBUG /O2 /fp:fast /Qpar /GS- /Z7 /MD
