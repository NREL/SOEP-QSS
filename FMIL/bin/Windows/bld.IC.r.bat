...
set FMIL_C_FLAGS="/nologo /Qansi-alias /EHsc /QxHOST /Wall /Qdiag-disable:10382,10441,11074,11075 /DNOMINMAX /DWIN32_LEAN_AND_MEAN /DWIN32 /DNDEBUG /O3 /fp:fast /Qip /Qinline-factor:2000 /MD"
set FMIL_CMAKE_ARGS=-DFMILIB_INSTALL_PREFIX=%FMIL_INS_DIR% %FMIL_SRC_DIR% -DCMAKE_BUILD_TYPE=Release -DCMAKE_FMIL_C_FLAGS_RELEASE=%FMIL_C_FLAGS%
