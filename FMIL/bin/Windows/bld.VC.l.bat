...
set FMIL_INS_DIR=C:\FMIL.VC.l
if exist "%FMIL_INS_DIR%" rd /S /Q "%FMIL_INS_DIR%" >nul 2>&1
del CMakeCache.txt >nul 2>&1

set FMIL_C_FLAGS="/nologo /std:c17 /EHsc /arch:AVX2 /W4 /wd4068 /DNOMINMAX /DWIN32_LEAN_AND_MEAN /DWIN32 /DNDEBUG /O2 /fp:fast /Qpar /GS- /GL /MD"
set FMIL_LINK_FLAGS="/LTCG"
