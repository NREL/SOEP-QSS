...
set FMIL_C_FLAGS="/nologo /Qansi-alias /EHsc /QxHOST /Wall /Wno-unused-function /DNOMINMAX /DWIN32_LEAN_AND_MEAN /DWIN32 /DNDEBUG /O3 /fp:fast /Z7 /MD"
set FMIL_LINK_FLAGS="/DEBUG /PROFILE"
set FMIL_CMAKE_ARGS=-DCMAKE_C_COMPILER=icx -DCMAKE_CXX_COMPILER=icx -DFMILIB_INSTALL_PREFIX=%FMIL_INS_DIR% %FMIL_SRC_DIR% -DCMAKE_BUILD_TYPE=Release -DCMAKE_FMIL_C_FLAGS_RELEASE=%FMIL_C_FLAGS% -DCMAKE_FMIL_LINK_FLAGS=%FMIL_LINK_FLAGS%
