@echo off
:: Build FMIL Windows Intel C++ Profile
...
set CC=icx
set C_FLAGS=/nologo /Qstd:c2x /EHsc /QxHOST /Wall /Wno-unused-function /DNOMINMAX /DWIN32_LEAN_AND_MEAN /DNDEBUG /O3 /fp:fast /Z7 /MD
